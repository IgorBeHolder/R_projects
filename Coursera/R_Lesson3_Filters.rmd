...
ggplot(data = hotel_bookings) +
  ...
  labs(title = "Hotel types and market segments",
       subtitle = "Which market segments generate the largest number of bookings, and where these bookings are made (city hotels or resort hotels)",
       caption = paste("Last updated:", as.character(today()-1) ) )+
  annotate("text", x= 1.8, y= 4.5e4, label= "The cap", 
