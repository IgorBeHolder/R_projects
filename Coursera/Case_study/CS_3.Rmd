...
|                                |                  | [](images/Google.jpeg) |
+--------------------------------+------------------+------------------------+
| Coursera is the global online  |                  | Google is a            |
| learning platform that offers  |                  | multinational          |
| anyone, anywhere access to     |                  | corporation            |
| online courses and degrees     |                  | specializing in        |
| from world-class universities  |                  | internet-related       |
| and companies.                 |                  | services and products. |
+--------------------------------+------------------+------------------------+
...
+---------+---------+---------+---------+---------+---------+---------+
| A t     | min     | max     | number  | Domain  | -   \   | Notes   |
| tribute | value   | value   | of NA   | i n     |     \   |         |
|         |         |         |         | tegrity |     \   |         |
|         |         |         |         |         |     \   |         |
|         |         |         |         |         |     \   |         |
|         |         |         |         |         |     \   |         |
...
+=========+=========+=========+=========+=========+=========+=========+
| st a    | `       | `       | 0       | \+      | \+      |         |
| rted_at | 2 02 2  | 2 02 3  |         |         |         |         |
|         |  -01 -  |  -01 -  |         |         |         |         |
|         | 01 0 0  | 31 2 3  |         |         |         |         |
|         | :00:05` | :56:09` |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| e       | `       | `       | 0       | \+      | \+      |         |
| nded_at | 2 02 2  | 2 02 3  |         |         |         |         |
|         |  -01 -  |  -02 -  |         |         |         |         |
|         | 01 0 0  | 04 0 4  |         |         |         |         |
|         | :01:48` | :27:03` |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| trip\_  | -   1   | 4       | 0       | fault   | \+      | ne g    |
| d       |         | 1387.25 |         |         |         | atives, |
| uration | 0353.35 |         |         |         |         | very    |
|         |         |         |         |         |         | high    |
|         |         |         |         |         |         | `s      |
|         |         |         |         |         |         | td dev` |
+---------+---------+---------+---------+---------+---------+---------+
| s t     | 41.64   | 4       | 0       | fault   | \+      | too big |
| art_lat |         | 5.63503 |         |         |         | range   |
|         |         |         |         |         |         | for a   |
|         |         |         |         |         |         | city    |
+---------+---------+---------+---------+---------+---------+---------+
| s t     | -87.8   | -73.796 | 0       | fault   | \+      | too big |
| art_lng |         |         |         |         |         | range   |
|         |         |         |         |         |         | for a   |
|         |         |         |         |         |         | city    |
+---------+---------+---------+---------+---------+---------+---------+
| end_lat | 0.00    | 4       | 5985    | fault   | fault   | zeros   |
|         |         | 2.37000 |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
...
The surge at mark 25h(1500 minutes) **might be a service notation**, e.g. bikes
that had been left out of parking stations, fully discharged, defected or stolen
bikes.
...
We found a significant differences in behaviour among riders segments.\
**Members** use Cyclistics to fulfill their day-day obligations, e.g. commute to
work or school, run errands.\
...
| duration         |                             |                           |
+------------------+-----------------------------+---------------------------+
| mode of day of   | Tue, Wed, Thu               | Sat                       |
| week             |                             |                           |
+------------------+-----------------------------+---------------------------+
| bike type        | doesn't matter              | e-bike                    |
| preference       |                             |                           |
+------------------+-----------------------------+---------------------------+
| anti-mode of day | Sun                         | Mon-Tue                   |
| of week          |                             |                           |
+------------------+-----------------------------+---------------------------+
| weather          | medium                      | high                      |
| dependence       |                             |                           |
...
| trip cost        |                             |                           |
+------------------+-----------------------------+---------------------------+
| most likely      | commute to work or school,  | explore Chicago, get to   |
| purpose of use   | run errands, performing     | appointments or social    |
|                  | daily duties                | engagements               |
+------------------+-----------------------------+---------------------------+
| membership       | 119\$                       | 0\$                       |
+------------------+-----------------------------+---------------------------+
| classic bike     | 0\$                         | 1\$                       |
...
-   Finish the report as is -\> Conclusions

-   Add Boston 2022 weather (temperature, precipitation)

-   `trip_cost` add 2022 pricing

-   add viz with geo data most pop stations

-   correlation member_casual - weather
