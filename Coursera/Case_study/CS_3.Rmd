...
We've selected appropriate .zip files from Jan2022 till Jan2023 (13 months of data were available as of the date of this report) and store them locally at `zip_dir` folder.\
...
df %>% 
  ...
  crosstable(c(rideable_type), by=member_casual, total="both", showNA="no", 
        percent_digits=0, percent_pattern="{n} ({p_col})") %>% # , percent_pattern="{n} ({p_col}/{p_row})"
